...
// InitSql is a collection of sqlite statements used to initialize a SIFT
// database
var InitSql = `
...
CREATE UNIQUE INDEX IF NOT EXISTS adapter_credential_by_adapter_name_key
    ON adapter_credential ( adapter_name, key );
